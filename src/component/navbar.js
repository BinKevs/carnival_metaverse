    ...
    return (
      <>
        <div className="flex justify-center text-white text-lg font-black my-20">
          <div className="space-x-6 lg:space-x-12 lg:p-7 p-4 px-14 md:block hidden">
            <Link
        ...
        {!ShowNav ? (
          <div className="md:hidden  fixed top-10 right-3 bg-fifth-black-color p-5 rounded-3xl">
            <img
              src={navbar}
              alt=""
        ...
        {ShowNav ? (
          <div className="md:hidden  fixed top-2 right-2 bg-white bg-opacity-20 rounded-xl z-30">
            <img
              src={close}
              alt=""
              className="w-12 "
        ...
        <div className="fixed md:bottom-10 bottom-0 w-full flex justify-between md:px-16 z-10">
          <div className="bg-white bg-opacity-20 rounded-3xl space-y-8 py-10 px-2 md:z-10">
